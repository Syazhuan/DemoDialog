    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDemo3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //It needs to be defined as "final", so that it can used in the onClick() method
        ...
        btnEx3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final EditText etInput1 = viewDialog.findViewById(R.id.editTextFirstNum);
                final EditText etInput2 = viewDialog.findViewById(R.id.editTextSecondNum);
                ...
                myBuilder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        // Extract the text entered by the user from the EditText views
                        String inputText1 = etInput1.getText().toString();
